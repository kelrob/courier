        ...
        <div class="single_slider  d-flex align-items-center slider_bg_1">
            <div class="container">
                <div class="row align-items-center justify-content-center" align="center">
                    <div class="col-xl-8" style="margin-top: -7%;">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single_transport">
                        ...
                        <p>Pickup and Deliever is what we do. Just call us and we are there</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single_transport">
                        ...
                        <p>Monitor the progress of your package in realtime.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single_transport">
                        ...
                        <p>We Deliver From local to local and from local to global</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-5 col-md-6">
                    <div class="call_add_action">
                        <a href="#" class="boxed-btn3">+17814863623</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row  align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="features_info">
                            ...
                            <ul>
                                <li> Parcel And Document Shipping </li>
                    ...
                    <div class="testmonial_active owl-carousel">
                        <div class="single_carousel">
                            <div class="single_testmonial text-center">
                                ...
                                <p>One of the most outstanding services so far, Infact the very best..</p>
                        ...
                        <div class="single_carousel">
                            <div class="single_testmonial text-center">
                                ...
                                <p>I am impressed at the manner and approach towards work</p>
                                <div class="testmonial_author">
                                    <div class="thumb">
                                        <!-- <img src="img/case/testmonial.png" alt=""> -->
                                    </div>
                        ...
                        <div class="single_carousel">
                            <div class="single_testmonial text-center">
                                ...
                                <p>I honestly did not expect that my Package will get delivered before the time expected. Nice one guys. Welldone.</p>
                                <div class="testmonial_author">
                                    <div class="thumb">
                                        <!-- <img src="img/case/testmonial.png" alt=""> -->
                                    </div>
